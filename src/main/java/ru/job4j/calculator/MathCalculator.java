...
public class MathCalculator {
    ...
    public static double sumAndMinusAndMultiplyAndDivide(double first, double second) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Результат расчета равен: " + sumAndMinusAndMultiplyAndDivide(10, 20));
    }
}
